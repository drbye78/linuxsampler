...
#define CONFIG_EG_MIN_RELEASE_TIME 0.0025f
...
/* Define to 1 if pthread_testcancel() is available. */
#define CONFIG_PTHREAD_TESTCANCEL 1
...
#define CONFIG_SIGNED_TRIANG_ALGO 2
...
#define CONFIG_UNSIGNED_TRIANG_ALGO 2
...
/* #undef HAVE_JACK_MIDI_GET_EVENT_COUNT */

/* Define to 1 if you have the `jack_on_info_shutdown' function. */
/* #undef HAVE_JACK_ON_INFO_SHUTDOWN */
...
#define PACKAGE_STRING "linuxsampler 2.1.1.svn54"
...
#define PACKAGE_VERSION "2.1.1.svn54"
...
#define VERSION "2.1.1.svn54"

#define CONFIG_PLUGIN_DIR "plugins"
